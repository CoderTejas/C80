name_of_the_students_array = [];
 function submit() {
     ...
     document.getElementById("display_name_without_commas").innerHTML.HTML = remove_commas;
 ...
 function sorting() {
    ...
    var lenght_of_name_of_students_array = name_of_the_students_array.length; 
    console.log(lenght_of_name_of_students_array); 
    for (var k = 0; k < lenght_of_name_of_students_array; k++) { 
        display_student_array_sorting.push("<h4>NAME - " + name_of_the_students_array[k] + "</h4>"); 
